    ...
    <div class="home-list">
      ...
      >
       <div class="item-container">
          ...
          <div class="meta">
            <div v-if="item.date" class="meta-item time">
              ...
              <div class="mate-item-content">{{item.date}}</div>
            </div>
            <div v-if="item.categories" class="meta-item categories">
              ...
              <div class="mate-item-content">{{item.categories}}</div>
            </div>
            <div v-if="item.readTime" class="meta-item read">
              ...
              <div class="mate-item-content">{{item.readTime}}</div>
            </div>
          </div>
