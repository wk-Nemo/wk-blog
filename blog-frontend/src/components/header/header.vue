...
.header {
  ...
  .header-banner {
    ...
    background: url("../../assets/img/background-light.jpeg") no-repeat center/cover;
    .header-banner-info {
      position: absolute;
      top: 50%;
      left: 0;
